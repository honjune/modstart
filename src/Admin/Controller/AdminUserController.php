...
class AdminUserController extends Controller
{
    ...
    protected function grid()
    {
        $grid = new Grid(AdminUser::class, function (Grid $grid) {
            ...
            $grid->text('last_login_time', L('Last Login Time'));
            $grid->text('last_login_ip', L('Last Login Ip'));
        ...
        $form = new Form(AdminUser::class, function (Form $form) {
            ...
            $form->hookSaving(function (Form $form) {
                if ($form->isModeAdd()) {
                    ...
                    $data['password_salt'] = Str::random(16);
                    $data['password'] = Admin::passwordEncrypt($data['password'], $data['password_salt']);
