...
class AuthController extends Controller
{
    ...
    public function loginQuick()
    {
        ...
        $sign = md5($id . ':' . $ts . ':' . $adminUser['password'] . ':' . $adminUser['password_salt']);
    ...
    public function logout()
    {
        ...
        AdminUserLogoutEvent::fire($admin_user_id, Request::ip(), AgentUtil::getUserAgent());
        if (modstart_config('adminSSOClientEnable', false)) {
            $input = InputPackage::buildFromInput();
    ...
    public function ssoClient()
    {
        ...
        if ($server) {
            ...
            Session::put('_admin_user_id', $adminUser['id']);
    ...
    public function ssoServer()
    {
        ...
        if (Session::get('_admin_user_id', 0)) {
    ...
    public function ssoServerSuccess()
    {
        ...
        $adminUser = Admin::get(Session::get('_admin_user_id', 0));
