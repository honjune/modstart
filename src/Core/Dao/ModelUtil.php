...
//    }
     ...
     * @example
     *
     * 表 user_article ( corpId, user_id, articleId )
     * relationAssign('user_article','user_id',1,'articleId',[4,5,6],['corpId'=>5])
     *
     * 表 user_article ( user_id, articleId )
     * relationAssign('user_article','user_id',1,'articleId',[4,5,6])
     */
     ...
     * ];
     */
    public static function join(&$records, $dataModelKey = 'user_id', $dataMergedKey = '_user', $model = 'join_model', $modelPrimaryKey = 'id')
    {
        if (empty($records)) {
            return;
        }
    ...
    public static function joinItems(&$items, $dataModelKey = 'user_id', $dataMergedKey = '_user', $model = 'join_model', $modelPrimaryKey = 'id')
    {
        if (empty($items)) {
            return;
        }
    ...
    public static function joinAll(&$data, $dataModelKey = 'user_id', $dataMergedKey = '_user', $model = 'join_model', $modelPrimaryKey = 'id')
    {
        if (empty($data)) {
            return;
        }
